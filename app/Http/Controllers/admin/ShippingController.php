...
class ShippingController extends Controller
{
    ...
    public function store(Request $request){
        ...
        if($validator->passes()){
            ...
            session()->flash('success','Shipping added sucsessfully');
    ...
    public function update(Request $request, $id){
        ...
        if($validator->passes()){
            ...
            session()->flash('success','Shipping updated sucsessfully');
    ...
    public function destroy($id){
        ...
        session()->flash('success','Shipping deleted sucsessfully');
