                                        ...
                                        <div class="d-block d-sm-flex align-items-start text-center text-sm-start">
                                            ...
                                            <div class="pt-2">
                                                ...
                                                <div class="fs-lg text-accent pt-2">
                                                    <span class="h5"><strong>Rp{{ $WL->product->price }}</strong></span>
                                                    @if ($WL->product->compare_price > 0)
                                                        <span class="h6 text-underline"><del>Rp{{ $WL->product->compare_price }}</del></span>
                                                    @endif
                                                </div>
                                            </div>
